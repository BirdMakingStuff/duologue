...
export default function EdEmbed(threadObj) {
    return new EmbedBuilder()
        ...
        .setAuthor((threadObj.user_id === 0) ? {name: `Anonymous #${threadObj.anonymous_id}`} : {name: threadObj.user.name, iconURL: (threadObj.user.avatar === null) ? null : `https://static.au.edusercontent.com/avatars/${threadObj.user.avatar}?s=128&fallback=1`}  )
